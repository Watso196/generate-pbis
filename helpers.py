...
def format_custom_acceptance_criteria(raw_text, testing_account_html, page_url=None, is_app=False, page_location=None):
    ...
    if is_list_mode:
        ...
        if page_url and not is_app:
            return build_custom_acceptance_criteria_list(
                list_items_html,
                page_url,
                testing_account_html
            )
        elif is_app and page_location:
            return build_app_custom_acceptance_criteria_list(
                list_items_html,
                page_location,
                testing_account_html
            )
        ...
        if page_url and not is_app:
            ...
            return build_app_custom_acceptance_criteria_paragraph(
                html.escape(raw_text),
                page_location,
                testing_account_html
            )
